...
// const BASE_URL = `${API_BASE}/api/offers`; // Adjust backend route name
...
//   // Fetch dynamic offers from server
//   useEffect(() => {
...
//         return expiry >= today; // Only show if still valid
//     });
...
//     // ✅ Only render section if there are valid offers
...
//                     {/* Content */}
//                     <div className="p-6">
//                     <h3 className="text-xl font-bold text-gray-800 mb-2 group-hover:text-rose-800 transition-colors">
//                         {offer.title}
//                     </h3>
...
//                     </div>
//                     <button className="w-full bg-gradient-to-r from-rose-600 to-red-700 text-white py-3 rounded-lg font-semibold hover:from-rose-700 hover:to-red-800 transition-all duration-300 shadow-md hover:shadow-lg">
//                         View Details
//                     </button>
//                     </div>
//                 </div>
...
//             {/* Modal Header */}
//             <div className="flex items-center justify-between p-4 sm:p-6 border-b bg-gradient-to-r from-rose-600 to-red-700 text-white">
//               <div>
